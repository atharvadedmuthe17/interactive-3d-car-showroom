...
const projects = [
  ...
  },
  {
    ...
    links: { live: "https://github.com/atharvadedmuthe17/OrderEase", code: "#" },
    image: "/p3.png",
    cta: "View on Github"
  },
  {
    ...
    links: { live: "https://github.com/atharvadedmuthe17/Busbuddy-latest", code: "#" },
    image: "/p4.png",
    cta: "View on Github"
  },
];
...
const SelectedWorks = () => {
  ...
  const textAnalyzeRef = useRef(null);
  const textDesignRef = useRef(null);
  const textBuildRef = useRef(null);
  const textDeliverRef = useRef(null);
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (kineticWheel) {
        if (scroll > endOffsetRef.current + containerHeight * 1.2 + containerHeight * 0.2) {
